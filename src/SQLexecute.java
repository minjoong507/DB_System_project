...
public class SQLexecute {
    ...
    public static void search_DB() {
        ...
        try {
            ...
            String bookupdateSQL = "Update department set building = '100' where dept_name = 'Physics'";
...
//            }
            ...
            if (result == 1) System.out.println("'age : 19. dept_name = Physics' 입력사항으로 갱신하였습니다.");
...
//            rs = stmt.executeQuery("select * from department where dept_name in (select dept_name from student where age = '21')");
